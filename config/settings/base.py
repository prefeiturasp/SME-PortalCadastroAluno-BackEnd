...
)  # (sme_portal_aluno_apps/config/settings/base.py - 3 = sme_portal_aluno_apps/)
APPS_DIR = ROOT_DIR.path("sme_portal_aluno_apps")
...
MIGRATION_MODULES = {"sites": "sme_portal_aluno_apps.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "sme_portal_aluno_apps.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "sme_portal_aluno_apps.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "sme_portal_aluno_apps.users.adapters.SocialAccountAdapter"
